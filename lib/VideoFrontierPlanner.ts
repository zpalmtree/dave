...
export function videoPlannerPromptCacheFields(
    ...
    const family = stage.startsWith('screenplay') ? 'screenplay' : 'analysis';
    return {
...
export async function createFrontierVideoPlan(
    ...
    const configured = configuredVideoPlannerVariant();
    const plannerModel = options.plannerModel || configured.plannerModel;
