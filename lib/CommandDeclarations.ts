...
const sharedCommands: Command[] = [
    {
        ...
        primaryCommand: {
            ...
            examples: [{ value: 'minimax an arcade kart race between historical figures' },
                { value: 'minimax --replace "the red car" keep its motion and the original soundtrack' }],
        },
    ...
    },
    {
        ...
        primaryCommand: {
            ...
            examples: [{ value: 'oalgo celebrates a championship victory' },
                ...
                { value: 'oalgo --replace "the dancer" keep the same moves' }],
        },
    ...
    },
    {
        ...
        primaryCommand: {
            ...
            description: 'Show this server\'s video queue or cancel one of your jobs',
            examples: [
                { value: 'videoqueue' },
